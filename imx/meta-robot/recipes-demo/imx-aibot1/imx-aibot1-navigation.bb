...
DESCRIPTION = "The i.MX Aibot1 navigation ros package"
...
DEPENDS = "${ROS_BUILD_DEPENDS} ${ROS_BUILDTOOL_DEPENDS} imx-aibot1-description"
...
SRC_URI = " file://imx-aibot1-navigation.tar.gz"
