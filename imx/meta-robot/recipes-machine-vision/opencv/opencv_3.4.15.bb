...
LIC_FILES_CHKSUM = "file://LICENSE;md5=5ad3c9c51e01436f2d6f3e566f90f66d"
...
SRCREV_opencv = "591708903b4393b5d33c3a2f4af5be4daeb94c4d"
SRCREV_contrib = "e9e507039d41fed009b72f9e163a22d9ae9f0712"
SRCREV_ipp = "32e315a5b106a7b89dbed51c28f8120a48b368b4"
SRCREV_boostdesc = "34e4206aef44d50e6bbcd0ab06354b52e7466d26"
SRCREV_vgg = "fccf7cd6a4b12079f73bbfb21745f9babcd4eb1d"
SRCREV_extra = "e79fc1824042cc57ff95547a50d5084881cb6056"
...
SRC_URI = "git://github.com/opencv/opencv.git;name=opencv \
    ...
    file://uselocalxfeatures-3.4.15.patch;patchdir=../contrib/ \
    file://0002-Make-opencv-ts-create-share-library-intead-of-static.patch \
    file://fixpkgconfig.patch \
    file://0001-To-fix-the-errors-for-Yocto-build.patch \
"
PV = "3.4.15"
...
PACKAGECONFIG ??= "python3 jpeg png tiff v4l libv4l gstreamer samples tbb gphoto2 ${@bb.utils.contains('DISTRO_FEATURES', 'x11', 'gtk', '', d)} \
    ${@bb.utils.contains("LICENSE_FLAGS_WHITELIST", "commercial", "libav", "", d)}"

PACKAGECONFIG:append_mx8   = " dnn text"
...
FILES:${PN} = "${datadir}/licenses ${libdir}/python3.10"
