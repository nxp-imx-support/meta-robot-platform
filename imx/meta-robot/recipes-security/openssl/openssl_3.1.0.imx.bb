...
SRC_URI = "https://www.openssl.org/source/openssl-3.1.0.tar.gz \
           file://run-ptest \
...
EXTRA_OECONF:append = " no-dynamic-engine"
EXTRA_OECONF:append:aarch64 = " -DHW_ENDIAN_SWAP"
...
do_change_name() {
    rm ${WORKDIR}/openssl-3.1.0.imx/ -rf
    mv ${WORKDIR}/openssl-3.1.0 ${WORKDIR}/openssl-3.1.0.imx
}
addtask do_change_name after do_unpack before do_patch
