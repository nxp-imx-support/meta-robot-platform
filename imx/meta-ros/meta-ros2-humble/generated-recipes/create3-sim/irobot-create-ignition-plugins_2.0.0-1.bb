...
# matches with: https://github.com/ros2-gbp/create3_sim-release/archive/release/humble/irobot_create_ignition_plugins/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/irobot_create_ignition_plugins"
SRC_URI = "git://github.com/ros2-gbp/create3_sim-release;${ROS_BRANCH};protocol=https"
SRCREV = "0cc8d9767ece5e4a03f272e77ffca79244e1c500"
S = "${WORKDIR}/git"
