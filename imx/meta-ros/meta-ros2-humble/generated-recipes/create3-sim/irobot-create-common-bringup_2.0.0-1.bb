...
# matches with: https://github.com/ros2-gbp/create3_sim-release/archive/release/humble/irobot_create_common_bringup/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/irobot_create_common_bringup"
SRC_URI = "git://github.com/ros2-gbp/create3_sim-release;${ROS_BRANCH};protocol=https"
SRCREV = "bf975765079327aa7e626b0eb0b87a334bbf87f4"
S = "${WORKDIR}/git"
