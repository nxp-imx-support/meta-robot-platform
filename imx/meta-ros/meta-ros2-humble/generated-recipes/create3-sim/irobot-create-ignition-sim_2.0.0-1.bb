...
ROS_CN = "create3_sim"
ROS_BPN = "irobot_create_ignition_sim"
...
# matches with: https://github.com/ros2-gbp/create3_sim-release/archive/release/humble/irobot_create_ignition_sim/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/irobot_create_ignition_sim"
SRC_URI = "git://github.com/ros2-gbp/create3_sim-release;${ROS_BRANCH};protocol=https"
SRCREV = "2d264005a54c0a1c901852ed4d0b6cb6bf39488d"
S = "${WORKDIR}/git"
