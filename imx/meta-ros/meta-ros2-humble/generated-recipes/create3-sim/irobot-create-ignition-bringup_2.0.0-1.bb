...
# matches with: https://github.com/ros2-gbp/create3_sim-release/archive/release/humble/irobot_create_ignition_bringup/2.0.0-1.tar.gz
...
SRCREV = "b69242d5a3b06539594285caa3dc61e85d3e5e31"
S = "${WORKDIR}/git"
