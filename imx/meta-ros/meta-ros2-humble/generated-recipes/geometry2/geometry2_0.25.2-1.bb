...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/humble/geometry2/0.25.2-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/geometry2"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "3f63d16db615942ec748d42aaed9a66cb1d97f89"
S = "${WORKDIR}/git"
