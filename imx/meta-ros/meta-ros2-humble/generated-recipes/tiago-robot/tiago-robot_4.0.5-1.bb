...
# matches with: https://github.com/pal-gbp/tiago_robot-release/archive/release/humble/tiago_robot/4.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/tiago_robot"
SRC_URI = "git://github.com/pal-gbp/tiago_robot-release;${ROS_BRANCH};protocol=https"
SRCREV = "5377555d5353a6ef638d68cd71888d6041c93836"
S = "${WORKDIR}/git"
