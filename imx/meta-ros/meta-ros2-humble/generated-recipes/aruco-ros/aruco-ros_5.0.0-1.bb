...
# matches with: https://github.com/pal-gbp/aruco_ros-release/archive/release/humble/aruco_ros/5.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/aruco_ros"
SRC_URI = "git://github.com/pal-gbp/aruco_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "e5370c9114acfd7f49bbce455f3ca341fa437864"
S = "${WORKDIR}/git"
