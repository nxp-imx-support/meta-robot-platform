...
# matches with: https://github.com/pal-gbp/aruco_ros-release/archive/release/humble/aruco_msgs/5.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/aruco_msgs"
SRC_URI = "git://github.com/pal-gbp/aruco_ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "415688390f27aafd2ac8fe4c52f72bf0e5f79f79"
S = "${WORKDIR}/git"
