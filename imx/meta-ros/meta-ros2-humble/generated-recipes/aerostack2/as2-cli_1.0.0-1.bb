...
# matches with: https://github.com/ros2-gbp/aerostack2-release/archive/release/humble/as2_cli/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/as2_cli"
SRC_URI = "git://github.com/ros2-gbp/aerostack2-release;${ROS_BRANCH};protocol=https"
SRCREV = "8ee96e8d0ee2399e5da51b97183ea78a797b3bd2"
S = "${WORKDIR}/git"
