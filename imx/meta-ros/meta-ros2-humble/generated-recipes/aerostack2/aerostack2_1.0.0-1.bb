...
# matches with: https://github.com/ros2-gbp/aerostack2-release/archive/release/humble/aerostack2/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/aerostack2"
SRC_URI = "git://github.com/ros2-gbp/aerostack2-release;${ROS_BRANCH};protocol=https"
SRCREV = "62f3ada5b064bfa4a1504fe9ecc05a2904eb9afc"
S = "${WORKDIR}/git"
