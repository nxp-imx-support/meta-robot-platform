...
# matches with: https://github.com/ros2-gbp/aerostack2-release/archive/release/humble/as2_msgs/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/as2_msgs"
SRC_URI = "git://github.com/ros2-gbp/aerostack2-release;${ROS_BRANCH};protocol=https"
SRCREV = "0d319d4957c0228808e6be3c3114db7a1003bd1a"
S = "${WORKDIR}/git"
