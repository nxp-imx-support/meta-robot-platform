...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_cmake_mypy/0.12.5-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/ament_cmake_mypy"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "0b55360fa6db762be6a84cd39ecf0a4e992364ea"
S = "${WORKDIR}/git"
