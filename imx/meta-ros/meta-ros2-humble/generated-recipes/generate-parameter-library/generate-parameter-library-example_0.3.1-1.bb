...
# matches with: https://github.com/ros2-gbp/generate_parameter_library-release/archive/release/humble/generate_parameter_library_example/0.3.1-1.tar.gz
...
SRCREV = "2b47eb37826a7492dd4bd9e8045369f10baf1a4e"
S = "${WORKDIR}/git"
