...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_ogre_vendor/11.2.5-1.tar.gz
ROS_BRANCH ?= "branch=release/humble/rviz_ogre_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "3164ebbc0fcb468250695b0276ef4f33784774e2"
S = "${WORKDIR}/git"
