...
# matches with: https://github.com/ros2-gbp/fastrtps-release/archive/release/rolling/fastrtps/2.9.1-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fastrtps"
SRC_URI = "git://github.com/ros2-gbp/fastrtps-release;${ROS_BRANCH};protocol=https"
SRCREV = "24c6b48d4541230c205b5d932a5830be9727cc34"
S = "${WORKDIR}/git"
