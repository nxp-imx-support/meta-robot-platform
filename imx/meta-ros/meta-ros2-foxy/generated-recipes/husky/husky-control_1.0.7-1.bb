...
# matches with: https://github.com/clearpath-gbp/husky-release/archive/release/foxy/husky_control/1.0.7-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/husky_control"
SRC_URI = "git://github.com/clearpath-gbp/husky-release;${ROS_BRANCH};protocol=https"
SRCREV = "839a5b93951f8bfef22ae207b3cd270c8c254ffb"
S = "${WORKDIR}/git"
