...
# matches with: https://github.com/ros2-gbp/octomap_mapping-release/archive/release/foxy/octomap_server/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/octomap_server"
SRC_URI = "git://github.com/ros2-gbp/octomap_mapping-release;${ROS_BRANCH};protocol=https"
SRCREV = "0971b5f4d56770aacf6996b5b79f19f61285058a"
S = "${WORKDIR}/git"
