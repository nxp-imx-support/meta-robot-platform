...
# matches with: https://github.com/ros2-gbp/octomap_mapping-release/archive/release/foxy/octomap_mapping/2.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/octomap_mapping"
SRC_URI = "git://github.com/ros2-gbp/octomap_mapping-release;${ROS_BRANCH};protocol=https"
SRCREV = "659cb24dced29bab24016780bbc4d2628daaa2df"
S = "${WORKDIR}/git"
