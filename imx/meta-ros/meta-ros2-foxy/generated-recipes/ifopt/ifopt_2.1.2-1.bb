...
# matches with: https://github.com/ethz-adrl/ifopt-release/archive/release/foxy/ifopt/2.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ifopt"
SRC_URI = "git://github.com/ethz-adrl/ifopt-release;${ROS_BRANCH};protocol=https"
SRCREV = "877bcde545eb6756d728506a81ccf8c7fa5fc1ce"
S = "${WORKDIR}/git"
