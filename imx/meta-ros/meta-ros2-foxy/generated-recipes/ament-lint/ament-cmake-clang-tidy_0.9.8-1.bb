...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/foxy/ament_cmake_clang_tidy/0.9.8-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ament_cmake_clang_tidy"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "38414a6d7687695e3b9b7f68376a8a26c0dad21a"
S = "${WORKDIR}/git"
