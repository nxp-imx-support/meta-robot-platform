...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/foxy/ament_cpplint/0.9.8-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ament_cpplint"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "47b8a5177fdc9fd2fd6082815c784cea953aac9d"
S = "${WORKDIR}/git"
