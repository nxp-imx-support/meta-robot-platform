...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/foxy/ament_xmllint/0.9.8-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ament_xmllint"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "316365605f530c675a60ef0cffa4a5fae80df908"
S = "${WORKDIR}/git"
