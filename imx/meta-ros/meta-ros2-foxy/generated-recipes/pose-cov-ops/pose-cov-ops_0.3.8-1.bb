...
# matches with: https://github.com/ros2-gbp/pose_cov_ops-release/archive/release/foxy/pose_cov_ops/0.3.8-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/pose_cov_ops"
SRC_URI = "git://github.com/ros2-gbp/pose_cov_ops-release;${ROS_BRANCH};protocol=https"
SRCREV = "c8b4cbf3b465d33ea16d04e9fe7359f5ad6ce6d3"
S = "${WORKDIR}/git"
