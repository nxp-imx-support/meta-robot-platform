...
# matches with: https://github.com/introlab/find_object_2d-release/archive/release/foxy/find_object_2d/0.7.0-3.tar.gz
ROS_BRANCH ?= "branch=release/foxy/find_object_2d"
SRC_URI = "git://github.com/introlab/find_object_2d-release;${ROS_BRANCH};protocol=https"
SRCREV = "8727f95c08c81543931571726098a30e4afbf91b"
S = "${WORKDIR}/git"
