...
# matches with: https://github.com/SICKAG/sick_safetyscanners_base-release/archive/release/foxy/sick_safetyscanners_base/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/sick_safetyscanners_base"
SRC_URI = "git://github.com/SICKAG/sick_safetyscanners_base-release;${ROS_BRANCH};protocol=https"
SRCREV = "a629f98b660be715afa6a9e528e805f88ca06785"
S = "${WORKDIR}/git"
