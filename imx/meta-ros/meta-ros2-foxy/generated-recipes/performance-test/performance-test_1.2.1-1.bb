...
# matches with: https://github.com/ros2-gbp/performance_test-release/archive/release/foxy/performance_test/1.2.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/performance_test"
SRC_URI = "git://github.com/ros2-gbp/performance_test-release;${ROS_BRANCH};protocol=https"
SRCREV = "e917b9300553d27e1a2ec3fbaf875ab15ab4b841"
S = "${WORKDIR}/git"
