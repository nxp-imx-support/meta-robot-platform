...
# matches with: https://github.com/stack-of-tasks/dynamic-graph-ros-release/archive/release/foxy/dynamic-graph/4.4.3-2.tar.gz
ROS_BRANCH ?= "branch=release/foxy/dynamic-graph"
SRC_URI = "git://github.com/stack-of-tasks/dynamic-graph-ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "96adba50e6f937a4887a5f577029a98f998c19eb"
S = "${WORKDIR}/git"
