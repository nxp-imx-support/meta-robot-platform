...
# matches with: https://github.com/ros2-gbp/rospy_message_converter-release/archive/release/foxy/rclpy_message_converter/2.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rclpy_message_converter"
SRC_URI = "git://github.com/ros2-gbp/rospy_message_converter-release;${ROS_BRANCH};protocol=https"
SRCREV = "326bab237da0a0c2782e9d93c48275751bd837d5"
S = "${WORKDIR}/git"
