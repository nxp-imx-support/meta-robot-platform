...
# matches with: https://github.com/ros2-gbp/kobuki_ros_interfaces-release/archive/release/foxy/kobuki_ros_interfaces/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/kobuki_ros_interfaces"
SRC_URI = "git://github.com/ros2-gbp/kobuki_ros_interfaces-release;${ROS_BRANCH};protocol=https"
SRCREV = "dba626a19bb1a3595fdea390e1792a5648ae81ba"
S = "${WORKDIR}/git"
