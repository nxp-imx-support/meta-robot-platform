...
# matches with: https://github.com/ros2-gbp/imu_tools-release/archive/release/foxy/imu_tools/2.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/imu_tools"
SRC_URI = "git://github.com/ros2-gbp/imu_tools-release;${ROS_BRANCH};protocol=https"
SRCREV = "812d64981a421903374e13664ba7e77ef3a5fd8b"
S = "${WORKDIR}/git"
