...
# matches with: https://github.com/ros2-gbp/image_common-release/archive/release/foxy/image_transport/2.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/image_transport"
SRC_URI = "git://github.com/ros2-gbp/image_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "9ad8f3db6952fcabe14c4a02728e560c5d4b2a7d"
S = "${WORKDIR}/git"
