...
# matches with: https://github.com/swri-robotics-gbp/gps_umd-release/archive/release/foxy/gpsd_client/1.0.6-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/gpsd_client"
SRC_URI = "git://github.com/swri-robotics-gbp/gps_umd-release;${ROS_BRANCH};protocol=https"
SRCREV = "2fd54ee8efb316480c1e85c586fbada392b2a56a"
S = "${WORKDIR}/git"
