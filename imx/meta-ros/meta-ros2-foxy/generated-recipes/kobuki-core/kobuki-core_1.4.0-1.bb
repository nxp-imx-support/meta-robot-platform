...
# matches with: https://github.com/ros2-gbp/kobuki_core-release/archive/release/foxy/kobuki_core/1.4.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/kobuki_core"
SRC_URI = "git://github.com/ros2-gbp/kobuki_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "69b3409741cad035eab2e36813ea91d21e6a0c53"
S = "${WORKDIR}/git"
