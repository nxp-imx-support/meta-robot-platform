...
# matches with: https://github.com/ros2-gbp/aruco_opencv-release/archive/release/foxy/aruco_opencv_msgs/1.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/aruco_opencv_msgs"
SRC_URI = "git://github.com/ros2-gbp/aruco_opencv-release;${ROS_BRANCH};protocol=https"
SRCREV = "14779e6ea3a646021f9614e2e62cadc40f26fad7"
S = "${WORKDIR}/git"
