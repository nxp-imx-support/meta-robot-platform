...
# matches with: https://github.com/ros2-gbp/kobuki_velocity_smoother-release/archive/release/foxy/kobuki_velocity_smoother/0.15.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/kobuki_velocity_smoother"
SRC_URI = "git://github.com/ros2-gbp/kobuki_velocity_smoother-release;${ROS_BRANCH};protocol=https"
SRCREV = "f876825cc24917bd189de81106772f0fdaec6587"
S = "${WORKDIR}/git"
