...
# matches with: https://github.com/ros2-gbp/joystick_drivers-release/archive/release/foxy/wiimote/3.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/wiimote"
SRC_URI = "git://github.com/ros2-gbp/joystick_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "ed9b2cf656d20d5b753fdeb7cbeb696a67d4e5ce"
S = "${WORKDIR}/git"
