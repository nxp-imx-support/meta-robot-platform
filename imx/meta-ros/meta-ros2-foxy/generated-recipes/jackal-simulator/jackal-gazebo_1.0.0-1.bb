...
# matches with: https://github.com/clearpath-gbp/jackal_simulator-release/archive/release/foxy/jackal_gazebo/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/jackal_gazebo"
SRC_URI = "git://github.com/clearpath-gbp/jackal_simulator-release;${ROS_BRANCH};protocol=https"
SRCREV = "2e5c6a5ebe67184d69ad4daece652c1d9bcbf97f"
S = "${WORKDIR}/git"
