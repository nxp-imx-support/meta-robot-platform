...
# matches with: https://github.com/ros-naoqi/libqicore-release/archive/release/foxy/naoqi_libqicore/2.9.7-0.tar.gz
ROS_BRANCH ?= "branch=release/foxy/naoqi_libqicore"
SRC_URI = "git://github.com/ros-naoqi/libqicore-release;${ROS_BRANCH};protocol=https"
SRCREV = "db533782fe33fe960efe19ead26c18291e6399dc"
S = "${WORKDIR}/git"
