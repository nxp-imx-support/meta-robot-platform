...
# matches with: https://github.com/ros2-gbp/swri_console-release/archive/release/foxy/swri_console/2.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/swri_console"
SRC_URI = "git://github.com/ros2-gbp/swri_console-release;${ROS_BRANCH};protocol=https"
SRCREV = "9140c009eb7b75aea54c1b0ccef364478daccb6a"
S = "${WORKDIR}/git"
