...
# matches with: https://github.com/luxonis/depthai-ros-release/archive/release/foxy/depthai_bridge/2.5.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/depthai_bridge"
SRC_URI = "git://github.com/luxonis/depthai-ros-release;${ROS_BRANCH};protocol=https"
SRCREV = "4ba2fce7446d26cd0038903f639591188e9dfa63"
S = "${WORKDIR}/git"
