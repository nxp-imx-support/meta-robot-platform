...
# matches with: https://github.com/ros2-gbp/schunk_svh_ros_driver-release/archive/release/foxy/schunk_svh_driver/2.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/schunk_svh_driver"
SRC_URI = "git://github.com/ros2-gbp/schunk_svh_ros_driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "d464c97a0fd7f4789c4457cab7e2716de7d15b2b"
S = "${WORKDIR}/git"
