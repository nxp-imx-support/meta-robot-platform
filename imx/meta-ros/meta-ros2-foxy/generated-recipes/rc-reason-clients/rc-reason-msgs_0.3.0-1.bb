...
# matches with: https://github.com/roboception-gbp/rc_reason_clients-release/archive/release/foxy/rc_reason_msgs/0.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rc_reason_msgs"
SRC_URI = "git://github.com/roboception-gbp/rc_reason_clients-release;${ROS_BRANCH};protocol=https"
SRCREV = "e3ccc5d2e2d7d8690d9af5770a0340177979e2eb"
S = "${WORKDIR}/git"
