...
# matches with: https://github.com/ros2-gbp/locator_ros_bridge-release/archive/release/foxy/bosch_locator_bridge/2.0.9-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/bosch_locator_bridge"
SRC_URI = "git://github.com/ros2-gbp/locator_ros_bridge-release;${ROS_BRANCH};protocol=https"
SRCREV = "fb0a67a9e152a958c20e83b540ab439213fd698d"
S = "${WORKDIR}/git"
