...
# matches with: https://github.com/ros2-gbp/vrpn_mocap-release/archive/release/foxy/vrpn_mocap/1.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/vrpn_mocap"
SRC_URI = "git://github.com/ros2-gbp/vrpn_mocap-release;${ROS_BRANCH};protocol=https"
SRCREV = "afcc703602ccda371dc54d7121774b24429713a4"
S = "${WORKDIR}/git"
