...
# matches with: https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/foxy/theora_image_transport/2.3.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/theora_image_transport"
SRC_URI = "git://github.com/ros2-gbp/image_transport_plugins-release;${ROS_BRANCH};protocol=https"
SRCREV = "a860d03c490ec0a398f8fc6c6168b9315bd6f85a"
S = "${WORKDIR}/git"
