...
# matches with: https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/foxy/ur_dashboard_msgs/2.0.2-2.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ur_dashboard_msgs"
SRC_URI = "git://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release;${ROS_BRANCH};protocol=https"
SRCREV = "740fc8bcac8adc3f05bd8e6a57024f5e2d7cfec2"
S = "${WORKDIR}/git"
