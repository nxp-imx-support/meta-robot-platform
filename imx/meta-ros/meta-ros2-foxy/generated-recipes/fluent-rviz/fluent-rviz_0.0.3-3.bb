...
# matches with: https://github.com/ros2-gbp/fluent_rviz-release/archive/release/foxy/fluent_rviz/0.0.3-3.tar.gz
ROS_BRANCH ?= "branch=release/foxy/fluent_rviz"
SRC_URI = "git://github.com/ros2-gbp/fluent_rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "1e9ddcb11a5d83957b6f8a6c9361b6ecd49dd4b8"
S = "${WORKDIR}/git"
