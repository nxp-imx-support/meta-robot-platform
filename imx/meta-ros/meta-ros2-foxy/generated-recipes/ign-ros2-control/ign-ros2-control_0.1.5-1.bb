...
# matches with: https://github.com/ros2-gbp/ign_ros2_control-release/archive/release/foxy/ign_ros2_control/0.1.5-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/ign_ros2_control"
SRC_URI = "git://github.com/ros2-gbp/ign_ros2_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "2df3085ebf70b52ccdd61c990ed43099a52f1521"
S = "${WORKDIR}/git"
