...
# matches with: https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/foxy/rosapi/1.3.1-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rosapi"
SRC_URI = "git://github.com/ros2-gbp/rosbridge_suite-release;${ROS_BRANCH};protocol=https"
SRCREV = "dbf78b17f65dcb96420e140ce48c85627c13d5d9"
S = "${WORKDIR}/git"
