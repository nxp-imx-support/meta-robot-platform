...
# matches with: https://github.com/MetroRobots/ros_system_fingerprint-release/archive/release/foxy/system_fingerprint/0.7.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/system_fingerprint"
SRC_URI = "git://github.com/MetroRobots/ros_system_fingerprint-release;${ROS_BRANCH};protocol=https"
SRCREV = "0f68d8314b19662ef7d472118732d1318648813e"
S = "${WORKDIR}/git"
