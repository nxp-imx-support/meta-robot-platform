...
# matches with: https://github.com/ros2-gbp/foonathan_memory_vendor-release/archive/release/foxy/foonathan_memory_vendor/1.2.0-1.tar.gz
...
SRCREV = "f7bfc65c4637f97ee88badc6278505570d28f60b"
S = "${WORKDIR}/git"
