...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/foxy/diagnostics/3.1.0-2.tar.gz
ROS_BRANCH ?= "branch=release/foxy/diagnostics"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "bda1fd7f5b03f40ee60fc77206a164b02d735ada"
S = "${WORKDIR}/git"
