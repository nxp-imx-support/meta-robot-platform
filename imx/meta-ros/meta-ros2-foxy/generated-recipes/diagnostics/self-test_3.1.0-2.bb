...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/foxy/self_test/3.1.0-2.tar.gz
ROS_BRANCH ?= "branch=release/foxy/self_test"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "041a998a6bab0e9f4c8412317fdda1154dd89657"
S = "${WORKDIR}/git"
