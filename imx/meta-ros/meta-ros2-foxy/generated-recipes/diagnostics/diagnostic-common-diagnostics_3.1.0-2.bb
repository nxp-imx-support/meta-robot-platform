...
# matches with: https://github.com/ros2-gbp/diagnostics-release/archive/release/foxy/diagnostic_common_diagnostics/3.1.0-2.tar.gz
ROS_BRANCH ?= "branch=release/foxy/diagnostic_common_diagnostics"
SRC_URI = "git://github.com/ros2-gbp/diagnostics-release;${ROS_BRANCH};protocol=https"
SRCREV = "953dc209c4fc89ae0f4e9cf2d8246420369351ec"
S = "${WORKDIR}/git"
