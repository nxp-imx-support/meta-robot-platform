...
# matches with: https://github.com/ros2-gbp/crane_plus-release/archive/release/foxy/crane_plus_gazebo/1.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/crane_plus_gazebo"
SRC_URI = "git://github.com/ros2-gbp/crane_plus-release;${ROS_BRANCH};protocol=https"
SRCREV = "e67ff7f1ee9516962304c885c460fd5db9255f2d"
S = "${WORKDIR}/git"
