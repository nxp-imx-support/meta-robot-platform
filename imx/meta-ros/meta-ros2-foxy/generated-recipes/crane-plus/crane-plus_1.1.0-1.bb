...
# matches with: https://github.com/ros2-gbp/crane_plus-release/archive/release/foxy/crane_plus/1.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/crane_plus"
SRC_URI = "git://github.com/ros2-gbp/crane_plus-release;${ROS_BRANCH};protocol=https"
SRCREV = "3a5b9839234fc2393e478693e50eca2502352d69"
S = "${WORKDIR}/git"
