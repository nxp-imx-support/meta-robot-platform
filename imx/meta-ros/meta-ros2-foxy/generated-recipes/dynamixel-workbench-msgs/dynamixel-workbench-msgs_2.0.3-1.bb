...
# matches with: https://github.com/ros2-gbp/dynamixel_workbench_msgs-release/archive/release/foxy/dynamixel_workbench_msgs/2.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/dynamixel_workbench_msgs"
SRC_URI = "git://github.com/ros2-gbp/dynamixel_workbench_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "2e22a4e732fc8b56f6cbe11f6f55803502e1dc2a"
S = "${WORKDIR}/git"
