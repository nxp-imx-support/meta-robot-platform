...
# matches with: https://github.com/moveit/moveit2-release/archive/release/foxy/chomp_motion_planner/2.2.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/chomp_motion_planner"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "c240fecbec167f18a5c5e78387a06101d5b98d7d"
S = "${WORKDIR}/git"
