...
# matches with: https://github.com/moveit/moveit2-release/archive/release/foxy/moveit_plugins/2.2.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/moveit_plugins"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "76eb6f1a4a0dc01109eaea2cfb583fac5d8a5b0c"
S = "${WORKDIR}/git"
