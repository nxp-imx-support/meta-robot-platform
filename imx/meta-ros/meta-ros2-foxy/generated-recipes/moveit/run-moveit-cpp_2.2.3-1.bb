...
# matches with: https://github.com/moveit/moveit2-release/archive/release/foxy/run_moveit_cpp/2.2.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/run_moveit_cpp"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "7df367298a41939f98191a640b00fe2b70a68282"
S = "${WORKDIR}/git"
