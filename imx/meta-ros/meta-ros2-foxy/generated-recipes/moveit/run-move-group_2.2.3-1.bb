...
# matches with: https://github.com/moveit/moveit2-release/archive/release/foxy/run_move_group/2.2.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/run_move_group"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "7681a7f0c67bbb92eeb7f86416cbd7a8046c40d0"
S = "${WORKDIR}/git"
