...
# matches with: https://github.com/moveit/moveit2-release/archive/release/foxy/moveit_runtime/2.2.3-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/moveit_runtime"
SRC_URI = "git://github.com/moveit/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "a51a454015f85530b18940c691ed6ac6f8909b8d"
S = "${WORKDIR}/git"
