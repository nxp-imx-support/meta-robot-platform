...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/foxy/zstd_vendor/0.3.10-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/zstd_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "df9ef1a905377e9a5cc7fa5414fa34ed6da39f7e"
S = "${WORKDIR}/git"
