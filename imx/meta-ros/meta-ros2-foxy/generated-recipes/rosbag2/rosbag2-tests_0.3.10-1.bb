...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/foxy/rosbag2_tests/0.3.10-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/rosbag2_tests"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "5a4ebfecb5b8a8679e50c82910f1140c2adc1ea6"
S = "${WORKDIR}/git"
