...
# matches with: https://github.com/SteveMacenski/spatio_temporal_voxel_layer-release/archive/release/foxy/spatio_temporal_voxel_layer/2.1.4-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/spatio_temporal_voxel_layer"
SRC_URI = "git://github.com/SteveMacenski/spatio_temporal_voxel_layer-release;${ROS_BRANCH};protocol=https"
SRCREV = "9b14d69050ab98e7a9b12a7481f2ac26bd0d350f"
S = "${WORKDIR}/git"
