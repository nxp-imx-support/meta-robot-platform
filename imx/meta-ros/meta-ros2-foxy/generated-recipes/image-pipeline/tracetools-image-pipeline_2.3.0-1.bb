...
# matches with: https://github.com/ros2-gbp/image_pipeline-release/archive/release/foxy/tracetools_image_pipeline/2.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/tracetools_image_pipeline"
SRC_URI = "git://github.com/ros2-gbp/image_pipeline-release;${ROS_BRANCH};protocol=https"
SRCREV = "c1532c54c3a15d0cd2a7d89ffcc0be38417833c9"
S = "${WORKDIR}/git"
