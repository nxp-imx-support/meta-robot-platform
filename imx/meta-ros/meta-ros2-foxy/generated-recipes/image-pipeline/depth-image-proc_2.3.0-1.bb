...
# matches with: https://github.com/ros2-gbp/image_pipeline-release/archive/release/foxy/depth_image_proc/2.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/depth_image_proc"
SRC_URI = "git://github.com/ros2-gbp/image_pipeline-release;${ROS_BRANCH};protocol=https"
SRCREV = "ba2f258d3cf4952074e9a26933966f4032696c95"
S = "${WORKDIR}/git"
