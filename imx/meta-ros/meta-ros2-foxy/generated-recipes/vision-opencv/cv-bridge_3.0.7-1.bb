...
# matches with: https://github.com/ros2-gbp/vision_opencv-release/archive/release/foxy/cv_bridge/3.0.7-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/cv_bridge"
SRC_URI = "git://github.com/ros2-gbp/vision_opencv-release;${ROS_BRANCH};protocol=https"
SRCREV = "16e6e3f3d0a80136576871acee81537e546e125a"
S = "${WORKDIR}/git"
