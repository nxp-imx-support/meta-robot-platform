...
# matches with: https://github.com/ros2-gbp/raspimouse_slam_navigation_ros2-release/archive/release/foxy/raspimouse_slam/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/raspimouse_slam"
SRC_URI = "git://github.com/ros2-gbp/raspimouse_slam_navigation_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "91f94f6af5a13d417a06e7913b43a9863ac38be2"
S = "${WORKDIR}/git"
