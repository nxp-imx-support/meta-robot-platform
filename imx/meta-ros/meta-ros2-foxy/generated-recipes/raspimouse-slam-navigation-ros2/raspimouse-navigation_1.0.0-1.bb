...
# matches with: https://github.com/ros2-gbp/raspimouse_slam_navigation_ros2-release/archive/release/foxy/raspimouse_navigation/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/foxy/raspimouse_navigation"
SRC_URI = "git://github.com/ros2-gbp/raspimouse_slam_navigation_ros2-release;${ROS_BRANCH};protocol=https"
SRCREV = "0d516e39073be45e38aa9b5d7e21ba31476238c3"
S = "${WORKDIR}/git"
