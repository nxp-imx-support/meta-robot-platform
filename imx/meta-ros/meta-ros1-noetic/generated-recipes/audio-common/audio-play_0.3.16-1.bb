...
# matches with: https://github.com/ros-gbp/audio_common-release/archive/release/noetic/audio_play/0.3.16-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/audio_play"
SRC_URI = "git://github.com/ros-gbp/audio_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "af722e2d4b495ddc02dfef58276e588a7d80bc22"
S = "${WORKDIR}/git"
