...
# matches with: https://github.com/septentrio-users/septentrio_gnss_driver-release/archive/release/noetic/septentrio_gnss_driver/1.2.3-1.tar.gz
...
SRCREV = "987088889dcc3e013e2be7aa4b5b69a76c8f71db"
S = "${WORKDIR}/git"
