...
# matches with: https://github.com/ros-gbp/ros_controllers-release/archive/release/noetic/rqt_joint_trajectory_controller/0.21.1-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/rqt_joint_trajectory_controller"
SRC_URI = "git://github.com/ros-gbp/ros_controllers-release;${ROS_BRANCH};protocol=https"
SRCREV = "bc9b9e407115ca6b5038c577f940ee398d1b7eae"
S = "${WORKDIR}/git"
