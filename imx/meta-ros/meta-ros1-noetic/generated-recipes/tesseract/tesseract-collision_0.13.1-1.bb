...
ROS_CN = "tesseract"
ROS_BPN = "tesseract_collision"

ROS_BUILD_DEPENDS = " \
    ${ROS_UNRESOLVED_DEP-bullet-extras} \
...
# matches with: https://github.com/ros-industrial-release/tesseract-release/archive/release/noetic/tesseract_collision/0.13.1-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/tesseract_collision"
SRC_URI = "git://github.com/ros-industrial-release/tesseract-release;${ROS_BRANCH};protocol=https"
SRCREV = "24cf458085d3793899b96267dbe9307e5f3b57f3"
S = "${WORKDIR}/git"
