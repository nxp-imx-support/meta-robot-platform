...
# matches with: https://github.com/ros-gbp/executive_smach-release/archive/release/noetic/smach/2.5.1-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/smach"
SRC_URI = "git://github.com/ros-gbp/executive_smach-release;${ROS_BRANCH};protocol=https"
SRCREV = "48d6b803751a27fae4ef5e0f61efb12858085a17"
S = "${WORKDIR}/git"
