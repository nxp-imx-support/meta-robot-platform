...
# matches with: https://github.com/mavlink/mavros-release/archive/release/noetic/mavros_msgs/1.15.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/mavros_msgs"
SRC_URI = "git://github.com/mavlink/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "a3aaa6274b0d60dfab50bd91257cd9b6c87da3cb"
S = "${WORKDIR}/git"
