...
# matches with: https://github.com/mavlink/mavros-release/archive/release/noetic/test_mavros/1.15.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/test_mavros"
SRC_URI = "git://github.com/mavlink/mavros-release;${ROS_BRANCH};protocol=https"
SRCREV = "37cfb58117b7a378c9c1462ee9072ec8b7e4cdca"
S = "${WORKDIR}/git"
