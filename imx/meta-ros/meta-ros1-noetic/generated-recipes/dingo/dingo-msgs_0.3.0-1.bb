...
# matches with: https://github.com/clearpath-gbp/dingo-release/archive/release/noetic/dingo_msgs/0.3.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/dingo_msgs"
SRC_URI = "git://github.com/clearpath-gbp/dingo-release;${ROS_BRANCH};protocol=https"
SRCREV = "747a79fdc5e45d2d4a811551b87f983d9edf1cbd"
S = "${WORKDIR}/git"
